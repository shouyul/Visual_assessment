...
% 
% 
% %% plot P1001 - timecourse
% figure;hold on
% set(gcf,'Position',[302   473   923   481])
% l = plot(times,100-class_errors_time_P1001);
% l(1).Color = cus_cmap{1};
% l(2).Color = cus_cmap{5};
% plot([0,30],[50,50],'--','LineWidth',2,'Color',cus_cmap{4});
% plot([5,5],[0,100],'--','LineWidth',2,'Color',cus_cmap{2})
% plot([25,25],[0,100],'--','LineWidth',2,'Color',cus_cmap{2})
% ylim([10,95]);
% ylabel('Classification accuracy (%)');
% xlabel('Time (s)')
% title('Tumbler Decoding Timecourse - P1001');
% set(gca,'FontSize',font_size);
% legend({'Goggles ON','Goggles OFF'})
% 
% 
% %% plot P1004 - timecourse
% figure;hold on
% set(gcf,'Position',[302   473   923   481])
% l = plot(times,100-class_errors_time_P1004);
% l(1).Color = cus_cmap{1};
% l(2).Color = cus_cmap{5};
% plot([0,30],[50,50],'--','LineWidth',2,'Color',cus_cmap{4});
% plot([5,5],[0,100],'--','LineWidth',2,'Color',cus_cmap{2})
...
% ylabel('Classification accuracy (%)');
% xlabel('Time (s)')
% title('Tumbler Decoding Timecourse - P1004');
% set(gca,'FontSize',font_size);
% legend({'Goggles ON','Goggles OFF'})
% 
% %% plot TEST - timecourse
% figure;hold on
% set(gcf,'Position',[302   473   923   481])
% l = plot(times_TEST,100-class_errors_time_TEST);
% l(1).Color = cus_cmap{1};
% l(2).Color = cus_cmap{5};
% plot([0,25],[50,50],'--','LineWidth',2,'Color',cus_cmap{4});
% plot([5,5],[0,100],'--','LineWidth',2,'Color',cus_cmap{2})
% plot([20,20],[0,100],'--','LineWidth',2,'Color',cus_cmap{2})
% ylim([10,95]);
% ylabel('Classification accuracy (%)');
% xlabel('Time (s)')
% title('Tumbler Decoding Timecourse - MB');
% set(gca,'FontSize',font_size);
% legend({'Goggles ON','Goggles OFF'})
